...
export const hotelsEn = [
    ...
    unitTypes: [
      {
        ...
        count: "10 rooms",
        description:
          "Comfortable back-view rooms for short stays and business trips.",
      },
      {
        title: "Superior Twin Room",
        count: "6 rooms",
        description:
          "Twin-bed rooms with practical essentials for business or shared stays.",
      },
      {
        title: "Deluxe King Room",
        count: "6 rooms",
        description:
          "City-view rooms with a clearer value step for urban travelers.",
      },
      {
        title: "Junior Suite",
        count: "6 suites",
        description: "City-view suites with added space and a living area.",
      },
      {
        title: "Deluxe Junior Suite",
        count: "36 suites",
        description:
          "Expanded suite options with king or twin bedding and a separate living area.",
      },
      {
        title: "Executive Suite",
        count: "6 suites",
        description: "Two-bedroom suite comfort for business and longer stays.",
      },
      {
        title: "Presidential Suite",
        count: "6 suites",
        description: "The highest city-view suite tier for premium stays.",
      },
    ],
    amenities: [
      ...propertyAmenitiesEn,
      "Meeting rooms",
      "Fully equipped gym",
      "Indoor pool at selected property",
    ],
    locationHighlight:
  ...
  },
  {
    ...
    unitTypes: [
      {
        title: "Deluxe King Studio",
        count: "1 studio",
        description: "A compact studio for simple, practical stays.",
      },
      {
        title: "One-Bedroom Apartments",
        count: "37 apartments",
        description: "Superior, deluxe, and premium layouts with living space.",
      },
      {
        title: "Two-Bedroom Apartments",
        count: "17 apartments",
        description:
          "Family, superior, and deluxe layouts with more space and privacy.",
      },
    ],
    ...
    unitTypes: [
      {
        title: "Studios",
        count: "2 studios",
        description: "King and twin studio choices for short, simple stays.",
      },
      {
        title: "One-Bedroom Apartments",
        count: "35 apartments",
        description:
          "Superior and deluxe categories with back-view and city-view options.",
      },
      {
        title: "Two-Bedroom Apartments",
        count: "9 apartments",
        description: "Superior and deluxe family layouts with two bathrooms.",
      },
    ],
    amenities: [
      ...propertyAmenitiesEn,
  ...
  },
  {
    ...
    unitTypes: [
      {
        title: "Deluxe Studios",
        count: "8 studios",
        description:
          "King and twin studio options for business and individual stays.",
      },
      {
        title: "One-Bedroom Apartments",
        count: "10 apartments",
        description: "Superior, deluxe, and premium options for added comfort.",
      },
      {
        title: "Two-Bedroom Apartments",
        count: "14 apartments",
        description:
          "Family, superior, and deluxe layouts for families and groups.",
      },
    ],
    amenities: [
      ...propertyAmenitiesEn,
      "Housekeeping",
      "Long-stay booking support",
    ],
    locationHighlight:
    ...
    unitTypes: [
      {
        title: "One-Bedroom Apartments",
        count: "21 apartments",
        description: "Superior, city-view, deluxe, and premium layouts.",
      },
      {
        title: "Two-Bedroom Apartments",
        count: "13 apartments",
        description:
          "Family, superior, and deluxe options with flexible living space.",
      },
      {
        title: "Three-Bedroom Superior Apartment",
        count: "1 apartment",
        description: "A wider layout for larger families and corporate stays.",
      },
    ],
    amenities: [
      ...propertyAmenitiesEn,
    ...
    unitTypes: [
      {
        title: "Studios",
        count: "8 studios",
        description: "King and deluxe king studio options for short stays.",
      },
      {
        title: "One-Bedroom Apartments",
        count: "26 apartments",
...
export const destinationsEn = [
  {
    ...
    howToEnjoy: [
      "Visit Jeddah Corniche and the waterfront",
      "Explore Historic Jeddah Al Balad",
      "Try restaurants and cafes",
  ...
  },
  {
    ...
    howToEnjoy: [
      "Visit Boulevard Riyadh and entertainment destinations",
      "Plan business meetings",
      "Discover premium restaurants",
      "Choose monthly stays for corporate assignments",
    ],
    image: jeddahImage,
  ...
  },
  {
    ...
    howToEnjoy: [
      ...
      "Plan regional business visits",
      "Choose an apart-hotel for longer stays",
    ],
    image: jazanImage,
...
export const roomClassificationsEn = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        bedrooms: "2",
        bedConfig: "Super King + 2 Single Beds",
        view: "Back View",
        bathrooms: "1",
        livingRooms: "1",
        totalUnits: "6",
  ...
  },
  {
    ...
    rows: [
      ...
      {
        type: "One-Bedroom Superior Apartment",
        bedrooms: "1",
        bedConfig: "Super King",
        view: "No View",
        bathrooms: "1",
      ...
      {
        type: "One-Bedroom Deluxe Apartment",
        bedrooms: "1",
        bedConfig: "Super King",
        view: "City View",
        bathrooms: "1",
      ...
      {
        type: "One-Bedroom Premium Apartment",
        bedrooms: "1",
        bedConfig: "Super King",
        view: "City View",
        bathrooms: "1",
      ...
      {
        type: "Two-Bedroom Family Apartment",
        bedrooms: "2",
        bedConfig: "Super King + 2 Single Beds",
        view: "No View",
        bathrooms: "2",
      ...
      {
        type: "Two-Bedroom Superior Apartment",
        bedrooms: "2",
        bedConfig: "Super King + 2 Single Beds",
        view: "City View",
        bathrooms: "2",
      ...
      {
        type: "Two-Bedroom Deluxe Apartment",
        bedrooms: "2",
        bedConfig: "Super King + 2 Single Beds",
        view: "City View",
        bathrooms: "2",
  ...
  },
  {
    ...
    rows: [
      ...
      {
        type: "Deluxe One-Bedroom Apartment with City View",
        bedrooms: "1",
        bedConfig: "2 Single Beds",
        view: "City View",
        bathrooms: "1",
  ...
  },
  {
    ...
    rows: [
      ...
      {
        type: "Three-Bedroom Superior Apartment",
        bedrooms: "3",
        bedConfig: "Super King + 4 Single Beds",
        view: "No View",
        bathrooms: "2",
        livingRooms: "2",
        totalUnits: "1",
  ...
  },
  {
    ...
    rows: [
      ...
      {
        type: "Two-Bedroom Apartment with City View",
        bedrooms: "2",
        bedConfig: "Super King + 2 Single Beds",
        view: "City View",
        bathrooms: "1",
