...
export const hotels = [
  ...
  },
  {
    ...
    image: jazanImage,
    summary:
      "وجهة شقق فندقية قادمة إلى جازان، وستُعلن تفاصيل الافتتاح والحجوزات قريباً.",
    positioning:
      "تستعد سويس بلو لإطلاق وجهة شقق فندقية في جازان. ستُنشر تفاصيل الوحدات والخدمات وموعد بدء الحجوزات عند اعتماد خطة الافتتاح.",
    unitTypes: [
      {
        title: "استوديوهات",
        count: "20 استوديو",
