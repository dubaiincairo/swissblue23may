...
export const hotels = [
  ...
  },
  {
    ...
    image: jazanImage,
    summary:
      "وجهة شقق مخدومة قادمة إلى جازان، وستُعلن تفاصيل الافتتاح والحجوزات قريباً.",
    positioning:
      "تستعد سويس بلو لإطلاق وجهة شقق مخدومة في جازان. ستُنشر تفاصيل الوحدات والخدمات وموعد بدء الحجوزات عند اعتماد خطة الافتتاح.",
    unitTypes: [
      {
        title: "استوديوهات",
        count: "20 استوديو",
  ...
  },
  {
    ...
    positioning:
      "تخدم شقق الزهراء المخدومة الضيوف الذين يفضلون تجربة شقة مخدومة في جدة مع سهولة الوصول إلى الخدمات والمطاعم ومراكز التسوق. الفئات مناسبة للعائلات، وضيوف الأعمال، والإقامات المتوسطة التي تحتاج إلى مساحة وخصوصية.",
    unitTypes: [
      {
        title: "استوديوهات",
        count: "14 استوديو",
...
export const accommodationCategories = [
  ...
  },
  {
    ...
    text: "تجمع بين راحة الفندق ومساحة الشقة، وتناسب العائلات والإقامات المتوسطة والضيوف الذين يحتاجون إلى مرونة أكبر.",
  },
  {
    title: "الشقق المخدومة",
    text: "مساحة وخصوصية ومرونة أكبر للعائلات والشركات، ومناسبة للإقامات القصيرة والمتوسطة والشهرية.",
  },
];
...
export const diningOptions = [
  ...
  {
    title: "المطعم",
    text: "خيارات طعام يومية تخدم الضيوف داخل الفندق أو الشقق المخدومة حسب توفر الخدمة في كل وجهة.",
  },
  {
    title: "خدمة الغرف",
...
export const faqs = [
  {
    ...
    answer:
      "يبدأ تسجيل الوصول القياسي عادةً اعتبارًا من الساعة 2:00 ظهراً، ويكون تسجيل المغادرة عادةً عند الساعة 12:00 ظهراً، ما لم يُذكر خلاف ذلك في تأكيد الحجز الخاص بك.",
  },
  {
    question: "هل تسمح فنادق سويس بلو باصطحاب الحيوانات الأليفة؟",
    answer:
      "لا يُسمح باصطحاب الحيوانات الأليفة حرصاً على راحة وأمان النزلاء.",
  },
  {
    question: "ما خيارات المواقف المتوفرة لدى سويس بلو؟",
    answer:
      "نعم. تتوفر خدمة مواقف السيارات المجانية لجميع الضيوف في جميع منشآت SwissBlue.",
  },
  {
