...
export const adminSections: AdminSection[] = [
  ...
  {
    id: "promotionalPopups",
    group: "Website",
    label: "Promotional pop-ups",
    description:
      "Create and update timed website promotions, including copy, eligibility, dates, imagery, design style, and booking actions.",
    path: ["promotionalPopups"],
  },
  {
    id: "navGroups",
    group: "Website",
...
export const arabicSectionLabels: Record<string, AdminSectionTranslation> = {
  ...
  promotionalPopups: {
    group: "الموقع",
    label: "النوافذ الترويجية",
    description:
      "إنشاء وتحديث عروض الموقع المؤقتة، بما يشمل النص والشروط والتواريخ والصورة ونمط التصميم وزر الحجز.",
  },
  social: {
...
export const fieldLabels: Record<string, string> = {
  ...
  promotionalPopups: "Promotional pop-ups",
  displayDelayMs: "Display delay (milliseconds)",
  id: "Promotion ID (change to show again)",
  designStyle: "Design style",
  meal: "Included dinner",
  alternative: "Meal alternative",
  eligibility: "Eligibility",
  bookingWindow: "Booking period shown to guests",
  stayWindow: "Stay period shown to guests",
  activeFrom: "Pop-up starts showing",
  activeUntil: "Pop-up stops showing",
  ctaLabel: "Booking button label",
  ctaHref: "Booking button URL",
  dismissLabel: "Close button accessibility label",
  ...
  enabled: "Show assistant on the website",
  avatar: "Assistant portrait",
  assistantRole: "Assistant role",
  onlineLabel: "Availability label",
  welcome: "Welcome message",
  placeholder: "Message field placeholder",
  leadActions: "Quick actions",
  leadComplete: "Lead confirmation messages",
...
export const arabicFieldLabels: Record<string, string> = {
  ...
  promotionalPopups: "النوافذ الترويجية",
  displayDelayMs: "تأخير الظهور (بالمللي ثانية)",
  id: "معرّف العرض (غيّره لإظهار العرض مجدداً)",
  designStyle: "نمط التصميم",
  meal: "العشاء المشمول",
  alternative: "بديل الوجبة",
  eligibility: "شروط الاستحقاق",
  bookingWindow: "فترة الحجز المعروضة للضيف",
  stayWindow: "فترة الإقامة المعروضة للضيف",
  activeFrom: "تاريخ بدء ظهور النافذة",
  activeUntil: "تاريخ توقف ظهور النافذة",
  ctaLabel: "نص زر الحجز",
  ctaHref: "رابط زر الحجز",
  dismissLabel: "وصف زر الإغلاق لقارئ الشاشة",
  ...
  enabled: "إظهار المساعد على الموقع",
  avatar: "الصورة الرمزية للمساعد",
  assistantRole: "دور المساعد",
  onlineLabel: "حالة التوفر",
  welcome: "رسالة الترحيب",
  placeholder: "النص الإرشادي لحقل الرسالة",
  leadActions: "الإجراءات السريعة",
  leadComplete: "رسائل تأكيد الطلبات",
  booking: "طلب حجز",
  corporate: "طلب شركات",
  ...
  adminAuthBackdrop: "خلفية تسجيل دخول الإدارة",
  layout: "نمط الخلفية",
  photos: "صور الخلفية",
