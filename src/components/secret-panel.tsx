...
function ImageFieldEditor({
  ...
  const [pickerSource, setPickerSource] = useState<"unsplash" | "pexels" | "google" | null>(null);
      ...
      <div className="admin-image-control">
        ...
        <div className="admin-image-tools">
          ...
          <div className="admin-image-actions">
            ...
            <button
              type="button"
              className="admin-image-source-icon admin-image-source-google"
              onClick={() => setPickerSource("google")}
              aria-label={language === "ar" ? "ابحث في جوجل" : "Search Google"}
              title={language === "ar" ? "ابحث في جوجل" : "Search Google"}
            >
