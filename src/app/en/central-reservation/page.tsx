    ...
    <PageShellEn>
      ...
      <section className="reservation-command-section">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8">
          ...
          <div className="reservation-channel-grid" aria-label="Direct reservation channels">
            {content.channels.map((channel, index) => (
              ...
              >
                ...
                {channel.href ? (
                  <a className="reservation-channel-action" href={channel.href}>
                    {rich(channel.value)}
                  </a>
                ) : (
                  <span className="reservation-channel-action" aria-label={channel.value}>
                    {rich(channel.value)}
                  </span>
                )}
              </article>
