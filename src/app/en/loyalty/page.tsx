...
export default async function LoyaltyPageEn() {
  ...
  return (
    <PageShellEn>
      ...
      <CtaBandEn eyebrow={en.closingCtas.eyebrow} title={en.closingCtas.pages.loyalty.title} text={en.closingCtas.defaultText} cta={en.closingCtas.pages.loyalty.cta} />
      </>
      )}
    </PageShellEn>
  );
