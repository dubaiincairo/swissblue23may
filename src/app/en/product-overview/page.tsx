...
export const metadata: Metadata = {
  title: "Digital Platform Marketing Overview | Swiss Blue Hospitality",
  description:
    "Explore the strategic capabilities of Swiss Blue's digital hospitality platform: 24/7 AI Concierge, direct booking engine, bilingual parity, and real-time headless CMS.",
  alternates: {
    canonical: "https://swissblue.sa/en/product-overview",
    languages: {
...
export default async function ProductOverviewEnglishPage() {
        ...
        <div className={styles.topHeaderInner}>
          <div className="flex items-center gap-4">
            ...
            <span className={styles.brandBadge}>
              <Sparkles size={12} />
              <span>Hospitality Platform Deck</span>
            </span>
          </div>
        ...
        <div style={{ maxWidth: "80rem", margin: "0 auto", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", fontSize: "0.875rem", fontWeight: 600 }}>
              ...
              <Link href="/en/corporate-deals" className="text-[#4b5563] hover:text-[#1246a8]">
                Corporate B2B
              </Link>
            </div>
          </div>
          ...
          <div style={{ borderTop: "1px solid #f1f5f9", paddingTop: "1.25rem", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "0.75rem", fontSize: "0.75rem", color: "#94a3b8" }}>
            <p>© {new Date().getFullYear()} Swiss Blue Hospitality. All rights reserved.</p>
            <p>Kingdom of Saudi Arabia • Jeddah • Riyadh • Jazan</p>
          </div>
        </div>
      </footer>
    </div>
